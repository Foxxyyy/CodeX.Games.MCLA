...
{
    public class XftFile : PiecePack
    {
        public Rsc5Fragment<Rsc5Drawable> Fragment;

        public XftFile(Rpf3FileEntry file) : base(file)
        {
            Fragment = null;
        }
        ...
        public override void Load(byte[] data)
        {
            ...
            Fragment = r.ReadBlock<Rsc5Fragment<Rsc5Drawable>>();
